 ...
 * @version 1.0
 */
public class HeatMapGenJS {
	private static String inFile = "D:\\a分析GPS数据\\生成热力图0-5\\hebing50米.txt";
	private static String outFile = "D:\\a分析GPS数据\\生成热力图0-5\\热力图50米.js";
	...
	public static void main(String[] args) {
		...
		try {
			while ((gps = in.read()) != null) {
				...
				sb.append(" {\"lng\":").append(gps.getLongitude()).append(",")
						.append("\"lat\":").append(gps.getLatitude())
						.append(",\"count\":").append(gps.getcarName())
						.append("},\r\n");
			}
		} catch (IOException e) {
			e.printStackTrace();
